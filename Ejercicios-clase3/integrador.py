...
X_test_sin_nans_reducido_pca = (X_test_sin_nans.dot( pca_sin_nans.components_.T))
X_test_nans_media_reducido_pca = (X_test_nans_media.dot( pca_nan_media.components_.T))
...
#### CONCLUSIONES #####
# El MSE para el dataset con los nans reemplazados por la media de la feature se comporta mejor que al eliminar los nans directamente
